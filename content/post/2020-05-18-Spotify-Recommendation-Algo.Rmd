---
title: "Build a Spotify Playlist Recommendation Model Using R"
author: "Ed Orlando"
date: '2020-05-18'
output:
  html_document:
...
In all, the final data set consisted of **~103K songs** and **18 variables**. You may download the .csv file and its contents **[here](https://ed-orlando-07-blog-site.netlify.app/zip_files/Spotify_Playlist.zip)** if you want to follow along.   
...
For access to more articles, please check out my **[blog](<https://ed-orlando-07-blog-site.netlify.app/>)**.
